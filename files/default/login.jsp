...
<html>
  ...
  <body>
    <div class="wrapper">
      <div class="container">
        <header>
          <a class="logo" href="../images/logo.jpg"><img src="<%= request.getContextPath()%>/images/logo.jpg" alt="Datadog Logo"/></a>
        </header>
        ...
        <div class="content">
          <div class="column one">
            ...
            <% } %>
              ...
              <legend>
                Log in to <idpui:serviceName/>, Datadog's SAML IdP.
              </legend>
      ...
      <footer>
        <div class="container container-footer">
          <p class="footer-text">Copyright Datadog, Inc. 2014 - <a href="https://app.datadoghq.com/policy/license">Terms of Use</a> - <a href="https://app.datadoghq.com/policy/privacy">Privacy Policy</a>.</p>
        </div>
      </footer>
    </div>
